...
exports.noop = exports.isChildrenNil = exports.getComponentName = exports.getChildren = exports.allowedChildren = void 0;
 ...
 * @returns {Boolean}
 */
var isChildrenNil = exports.isChildrenNil = function isChildrenNil(children) {
 ...
 * @returns {[]}
 */
var getChildren = exports.getChildren = function getChildren(children, types) {
  var ret = [];
  ...
  _react["default"].Children.toArray(children).forEach(function (item) {
    ...
    if (idx !== -1) {
      ...
      if (typeofIs === "function") {
        ...
        if (fIdx !== -1) {
          ret[fIdx] = /*#__PURE__*/_react["default"].cloneElement(item, _objectSpread(_objectSpread({}, item.props), {}, {
            as: null
        ...
        if (tIdx !== -1) {
          ret[tIdx] = /*#__PURE__*/_react["default"].cloneElement(item, _objectSpread(_objectSpread({}, item.props), {}, {
            as: null
          })); // Cloning to remove "as" attribute, which is not desirable
        }
 ...
 * @return {Function}
 */
var allowedChildren = exports.allowedChildren = function allowedChildren(allowedTypes) {
  return function (props, propName, componentName) {
    ...
    var forbidden = _react["default"].Children.toArray(props[propName]).find(function (item) {
