...
var _MessageCustomContent = _interopRequireDefault(require("./MessageCustomContent"));
var _MessageImageContent = _interopRequireDefault(require("./MessageImageContent"));
var _MessageHtmlContent = _interopRequireDefault(require("./MessageHtmlContent"));
var _MessageTextContent = _interopRequireDefault(require("./MessageTextContent"));
...
var Message = exports.Message = function Message(_ref) {
  ...
  var _getChildren = (0, _utils.getChildren)(children, [_Avatar["default"], _MessageHeader["default"], _MessageFooter["default"], _MessageHtmlContent["default"], _MessageTextContent["default"], _MessageImageContent["default"], _MessageCustomContent["default"]]),
  ...
  var messageContent = childContent !== null && childContent !== void 0 ? childContent : function () {
    ...
    var payloadName = _typeof(payload) === "object" ? (0, _utils.getComponentName)(payload) : "";
    if (messageType === "html" && payloadName !== "Message.CustomContent") {
      return /*#__PURE__*/_react["default"].createElement(_MessageHtmlContent["default"], {
        html: payload
      });
    } else if (messageType === "text") {
      return /*#__PURE__*/_react["default"].createElement(_MessageTextContent["default"], {
        text: payload
      });
    } else if (messageType === "image") {
      return /*#__PURE__*/_react["default"].createElement(_MessageImageContent["default"], payload);
  ...
  return /*#__PURE__*/_react["default"].createElement("section", _extends({}, rest, {
    ...
    className: (0, _classnames["default"])(cName, directionClass, _defineProperty({}, "".concat(cName, "--avatar-spacer"), avatarSpacer), positionClass, avatarPositionClass, className)
  }, _defineProperty({}, "data-".concat(_settings.prefix, "-message"), "")), typeof avatar !== "undefined" && /*#__PURE__*/_react["default"].createElement("div", {
...
process.env.NODE_ENV !== "production" ? Message.propTypes = {
  ...
  model: _propTypes["default"].shape({
    ...
    /** Position. */
    position: _propTypes["default"].oneOf(["single", "first", "normal", "last", 0, 1, 2, 3]),
    /**
     * Message type
     ...
     */
    payload: _propTypes["default"].oneOfType([_propTypes["default"].string, _propTypes["default"].object, (0, _utils.allowedChildren)([_MessageCustomContent["default"]])])
  }),
  avatarSpacer: _propTypes["default"].bool,
  avatarPosition: _propTypes["default"].oneOf(["tl", "tr", "cl", "cr", "bl", "br", "top-left", "top-right", "center-left", "center-right", "bottom-left", "bottom-right"]),
  /**
   * Primary content.
   ...
   */
  children: (0, _utils.allowedChildren)([_Avatar["default"], _MessageHeader["default"], _MessageFooter["default"], _MessageHtmlContent["default"], _MessageTextContent["default"], _MessageImageContent["default"], _MessageCustomContent["default"]]),
  /** Additional classes. */
   ...
   * custom: **Message.CustomContent** - Component
   */
  payload: _propTypes["default"].oneOfType([_propTypes["default"].string, (0, _utils.allowedChildren)([_MessageCustomContent["default"]])])
} : void 0;
